...
//An array is beautiful if the sum of  among  is minimal.
...
// Input Format
// The first line contains a single integer, n, the number of elements in . 
...
// Define  to be the beautiful reordering of . 
//The sum of the absolute values of differences between its adjacent elements is minimal among all permutations and only two swaps ( with  and then  with ) were performed.
/*
